...
class Plugin
{
    ...
    public static function apiRegister(GenericEvent $event)
    {
        ...
        api_register('api_validate_buy_vps', ['os' => 'string', 'slices' => 'int', 'platform' => 'string', 'controlpanel' => 'string', 'period' => 'int', 'location' => 'int', 'version' => 'string', 'hostname' => 'string', 'coupon' => 'string', 'rootpass' => 'string', 'ipv6only' => 'boolean'], ['return' => 'validate_buy_vps_result_status'], 'Checks if the parameters for your order pass validation and let you know if there are any errors. It will also give you information on the pricing breakdown.');
        api_register('api_buy_vps', ['os' => 'string', 'slices' => 'int', 'platform' => 'string', 'controlpanel' => 'string', 'period' => 'int', 'location' => 'int', 'version' => 'string', 'hostname' => 'string', 'coupon' => 'string', 'rootpass' => 'string', 'comment' => 'string', 'ipv6only' => 'boolean'], ['return' => 'buy_vps_result_status'], 'Places a VPS order in our system. These are the same parameters as api_validate_buy_vps.   Returns a comma seperated list of invoices if any need paid.');
        api_register('api_buy_vps_admin', ['os' => 'string', 'slices' => 'int', 'platform' => 'string', 'controlpanel' => 'string', 'period' => 'int', 'location' => 'int', 'version' => 'string', 'hostname' => 'string', 'coupon' => 'string', 'rootpass' => 'string', 'server' => 'int', 'comment' => 'string', 'ipv6only' => 'boolean'], ['return' => 'buy_vps_result_status'], 'Purchase a VPS (admins only).   Returns a comma seperated list of invoices if any need paid.  Same as client function but allows specifying which server to install to if there are resources available on the specified server.');
    ...
    public static function getSettings(GenericEvent $event)
    {
        ...
        $settings->add_master_status_label(self::$module, 'Server Settings', self::$module, 'available', 'vps_available', 'Auto-Setup', '<p>Shows whether auto-server setup is enabled or disabled for each server.</p>');
